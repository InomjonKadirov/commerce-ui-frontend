...
export const MENUITEMS: Menu[] = [
	{
		title: 'Электроника', type: 'sub', children: [
	...
	{
		title: 'Бытовая техника', type: 'sub', megaMenu: true, megaMenuType: 'small', children: [
	...
	{
		title: 'Акции', type: 'sub', megaMenu: true, megaMenuType: 'medium', children: [
	...
	{
		title: 'Для дома', type: 'sub', children: [
